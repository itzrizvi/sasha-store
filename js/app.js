// All Product Data Loader Function
const loadProducts = () => {
...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="single-product">
      ...
      <h3>${product.title}</h3>
      <p id="ratings">Average Rating: <span>${product.rating.rate}</span> <i class="fas fa-star-half-alt"></i></p>
      <p id="ratings">Reviewed By: <span>${product.rating.count}</span></p>
...
// Total Product Counting Function
let count = 0;
...
// Global Function For Getting the Values by ID
...
// Set innerText function for Tax Value and Delivery Charge
...
const updateTaxAndCharge = () => {
  ...
  // Conditions for Different Prices of Products Tax and Delivery Charge
  ...
  // Passing the Total Calculate Function
  updateTotal();
};
...
// Calling All Product Loader Function
loadProducts();